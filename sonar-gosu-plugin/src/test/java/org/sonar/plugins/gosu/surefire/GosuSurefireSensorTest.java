...
import org.sonar.plugins.gosu.surefire.api.SurefireUtils;
 ...
 */
public class GosuSurefireSensorTest {

  private DefaultFileSystem fs = new DefaultFileSystem(new File("."));
  private ResourcePerspectives perspectives;
  private GosuSurefireSensor surefireSensor;
  ...
  public void before() {
    ...
    surefireSensor = new GosuSurefireSensor(parser, mock(Settings.class), fs, pathResolver);
  }

  @Test
  public void test_description() {
    surefireSensor = new GosuSurefireSensor(new GosuSurefireParser(gosu, perspectives, fs), mock(Settings.class), fs, pathResolver);
  ...
  public void shouldNotFailIfReportsNotFound() {
    ...
    GosuSurefireSensor surefireSensor = new GosuSurefireSensor(mock(GosuSurefireParser.class), settings, fs, pathResolver);
  ...
  public void shouldHandleTestSuiteDetails() throws URISyntaxException {
    ...
    surefireSensor.collect(context, new File(getClass().getResource(
      "/org/sonar/plugins/gosu/surefire/SurefireSensorTest/shouldHandleTestSuiteDetails/").toURI()));
  ...
  public void shouldSaveErrorsAndFailuresInXML() throws URISyntaxException {
    ...
    surefireSensor.collect(context, new File(getClass().getResource(
      "/org/sonar/plugins/gosu/surefire/SurefireSensorTest/shouldSaveErrorsAndFailuresInXML/").toURI()));
  ...
  public void shouldManageClassesWithDefaultPackage() throws URISyntaxException {
    ...
    surefireSensor.collect(context, new File(getClass().getResource(
      "/org/sonar/plugins/gosu/surefire/SurefireSensorTest/shouldManageClassesWithDefaultPackage/").toURI()));
  ...
  public void successRatioIsZeroWhenAllTestsFail() throws URISyntaxException {
    ...
    surefireSensor.collect(context, new File(getClass().getResource(
      "/org/sonar/plugins/gosu/surefire/SurefireSensorTest/successRatioIsZeroWhenAllTestsFail/").toURI()));
  ...
  public void measuresShouldNotIncludeSkippedTests() throws URISyntaxException {
    ...
    surefireSensor.collect(context, new File(getClass().getResource(
      "/org/sonar/plugins/gosu/surefire/SurefireSensorTest/measuresShouldNotIncludeSkippedTests/").toURI()));
  ...
  public void noSuccessRatioIfNoTests() throws URISyntaxException {
    ...
    surefireSensor.collect(context, new File(getClass().getResource(
      "/org/sonar/plugins/gosu/surefire/SurefireSensorTest/noSuccessRatioIfNoTests/").toURI()));
  ...
  public void ignoreSuiteAsInnerClass() throws URISyntaxException {
    ...
    surefireSensor.collect(context, new File(getClass().getResource(
      "/org/sonar/plugins/gosu/surefire/SurefireSensorTest/ignoreSuiteAsInnerClass/").toURI()));
