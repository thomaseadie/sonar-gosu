...
public class GosuHighlighterAndTokenizer {

  private static final Logger LOG = Loggers.get(GosuHighlighterAndTokenizer.class);
  ...
  public GosuHighlighterAndTokenizer(InputFile inputFile) {
