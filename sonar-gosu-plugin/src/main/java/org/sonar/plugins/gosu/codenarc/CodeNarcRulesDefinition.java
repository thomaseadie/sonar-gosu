...
public class CodeNarcRulesDefinition implements RulesDefinition {
  ...
  private static final String COST_FILE_PATH = "/org/sonar/plugins/gosu/cost.csv";
  ...
  public void define(Context context) {
    ...
    ruleLoader.load(repository, CodeNarcRulesDefinition.class.getResourceAsStream("/org/sonar/plugins/gosu/rules.xml"), "UTF-8");
