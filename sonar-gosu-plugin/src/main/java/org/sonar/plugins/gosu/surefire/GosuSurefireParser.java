...
import org.sonar.plugins.gosu.surefire.data.SurefireStaxHandler;
import org.sonar.plugins.gosu.surefire.data.UnitTestClassReport;
import org.sonar.plugins.gosu.surefire.data.UnitTestIndex;
import org.sonar.plugins.gosu.surefire.data.UnitTestResult;
...
public class GosuSurefireParser {
  ...
  public GosuSurefireParser(Gosu gosu, ResourcePerspectives perspectives, FileSystem fs) {
    this.gosu = gosu;
  ...
  protected InputFile getUnitTestInputFile(String classKey) {
    ...
    FilePredicate fileNamePredicates = getFileNamePredicateFromSuffixes(p, fileName, gosu.getFileSuffixes());
    FilePredicate searchPredicate = p.and(p.and(p.hasLanguage(Gosu.KEY), p.hasType(InputFile.Type.TEST)), fileNamePredicates);
